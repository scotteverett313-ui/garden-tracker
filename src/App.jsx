...
function CTAButton({ onClick, children, style = {}, disabled = false }) {
  ...
  return (
    <div style={{ position: "relative", width: isFullWidth ? "100%" : "auto", display: isFullWidth ? "block" : "inline-block", paddingBottom: 4 }}>
      <div style={{ position: "absolute", left: 2, right: 2, bottom: 0, height: 8, background: "#000", borderRadius: 50, zIndex: 0 }} />
      <button onClick={onClick} disabled={disabled} className="btn-cta"
        style={{ position: "relative", zIndex: 1, width: "100%", background: disabled ? "#ccc" : "#a8e063", color: "#000", border: "2.5px solid #000", borderRadius: 50, cursor: disabled ? "not-allowed" : "pointer", fontWeight: 800, fontFamily: "inherit", transition: "transform 0.08s ease", ...style }}>
        {children}
      </button>
    </div>
  );
