  ...
  return (
    <div style={{ position: "relative", width: isFullWidth ? "100%" : "auto", display: isFullWidth ? "block" : "inline-block", paddingBottom: 4 }}>
      ...
      <button onClick={onClick} disabled={disabled} className="btn-cta"
        style={{ position: "relative", zIndex: 1, width: "100%", background: disabled ? "#ccc" : "#a8e063", color: "#000", border: "2.5px solid #000", borderRadius: 999, cursor: disabled ? "not-allowed" : "pointer", fontWeight: 800, fontFamily: "inherit", transition: "transform 0.08s ease", ...style }}>
        {children}
      </button>
    </div>
  );
    ...
    <div style={{ fontFamily: "system-ui, -apple-system, sans-serif", maxWidth: 600, margin: "0 auto", background: "#faf6f0", minHeight: "100vh", paddingBottom: 80 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <button onClick={() => setShowSettings(true)}
              style={{ background: "#000", border: "none", borderRadius: 12, width: 40, height: 40, cursor: "pointer", fontSize: 20, display: "flex", alignItems: "center", justifyContent: "center" }}>⚙️</button>
          </div>
        </div>
      ...
      {showSettings && (
        <SettingsPanel
          ...
          frostDates={frostDates}
          onSaveFrost={f => { saveFrost(f); toast("Frost dates saved", { icon: "❄️" }); }}
          plants={plants}
          seeds={seeds}
