...
export const ICON_LIBRARY = [
  ...
  { name: "Aster",           url: ASSET("Aster.png"),            tags: ["aster", "flower"] },
  { name: "Basil",           url: ASSET("Basil.png"),            tags: ["basil", "herb"] },
  { name: "Beet",            url: ASSET("Beet.png"),             tags: ["beet", "beetroot", "root"] },
  { name: "Bell Pepper",     url: ASSET("Bell Pepper.png"),      tags: ["pepper", "bell pepper", "capsicum"] },
  { name: "Borage",          url: ASSET("Borage.png"),           tags: ["borage", "herb", "flower"] },
  ...
  { name: "Collard Greens",  url: ASSET("Collard Greens.png"),   tags: ["collard greens", "collards", "greens"] },
  { name: "Cosmos",          url: ASSET("Cosmos.png"),           tags: ["cosmos", "flower"] },
  { name: "Craspedia",       url: ASSET("Craspedia.png"),        tags: ["craspedia", "billy buttons", "flower"] },
  { name: "Cucumber",        url: ASSET("Cucumber.png"),         tags: ["cucumber", "cuke"] },
  { name: "Dill",            url: ASSET("Dill.png"),             tags: ["dill", "herb"] },
  { name: "Eggplant",        url: ASSET("Eggplant.png"),         tags: ["eggplant", "aubergine"] },
  { name: "Garlic",          url: ASSET("Garlic.png"),           tags: ["garlic"] },
  { name: "Hot Pepper",      url: ASSET("Hot Pepper.png"),       tags: ["pepper", "hot pepper", "chili"] },
  { name: "Kale",            url: ASSET("Kale.png"),             tags: ["kale", "greens"] },
  { name: "Kohlrabi",        url: ASSET("Kohlrabi.png"),         tags: ["kohlrabi"] },
  { name: "Lettuce",         url: ASSET("Lettuce.png"),          tags: ["lettuce", "salad", "greens"] },
  { name: "Lobelias",        url: ASSET("Lobelias.png"),         tags: ["lobelia", "lobelias", "flower"] },
  { name: "Marigold",        url: ASSET("Marigold.png"),         tags: ["marigold", "flower"] },
  { name: "Mint",            url: ASSET("Mint.png"),             tags: ["mint", "herb"] },
  { name: "Mustard Greens",  url: ASSET("Mustard Greens.png"),   tags: ["mustard greens", "mustard", "greens"] },
  { name: "Okra",            url: ASSET("Okra.png"),             tags: ["okra"] },
  { name: "Onion",           url: ASSET("Onion.png"),            tags: ["onion"] },
  { name: "Parsley",         url: ASSET("Parsley.png"),          tags: ["parsley", "herb"] },
  { name: "Peas",            url: ASSET("Peas.png"),             tags: ["peas", "pea"] },
  { name: "Pumpkin",         url: ASSET("Pumpkin.png"),          tags: ["pumpkin", "gourd"] },
  { name: "Radish",          url: ASSET("Radish.png"),           tags: ["radish", "root"] },
  { name: "Rosemary",        url: ASSET("Rosemary.png"),         tags: ["rosemary", "herb"] },
  { name: "Spinach",         url: ASSET("Spinach.png"),          tags: ["spinach", "greens"] },
  { name: "Squash",          url: ASSET("Squash.png"),           tags: ["squash", "summer squash"] },
  { name: "Sunflower",       url: ASSET("Sunflower.png"),        tags: ["sunflower", "flower"] },
  { name: "Thyme",           url: ASSET("Thyme.png"),            tags: ["thyme", "herb"] },
  { name: "Tomato",          url: ASSET("Tomato.png"),           tags: ["tomato"] },
  { name: "Watermelon",      url: ASSET("Watermelon.png"),       tags: ["watermelon", "melon", "fruit"] },
  { name: "Zinna",           url: ASSET("Zinna.png"),            tags: ["zinnia", "zinna", "flower"] },
  { name: "Zucchini",        url: ASSET("Zuchinni.png"),         tags: ["zucchini", "zuchinni", "courgette", "squash"] },
];
